...
const processStepsData = [
  {
    header: {
      title: "3 Simple Steps to Success",
      highlighted: "",
      description:
    ...
    steps: [
      {
        ...
        description:
          "he first step after you submit your request is for us to assign you a dedicated manager that will be the best fit for you. They will then take care of everything else - review the design files and project specs, make sure we are on the same page, and clear up your expectations from us.",
